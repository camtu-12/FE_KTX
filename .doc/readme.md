...
12.	Bảng users (Tài khoản)
Quản lý tài khoản đăng nhập của sinh viên và admin.
-	users(id, student_id, email, password, role, is_active, created_at,
updated_at)
